...
fun Indicator(
    ...
    strokeWidth: StrokeCap = StrokeCap.Round, //width of cicle and ar lines
    ...
    val stroke = with(LocalDensity.current) {
        Stroke(width = 10.0F, cap = StrokeCap.Square)
    }
    ...
    Canvas(
        Modifier
            ...
            .padding(5.dp) //padding. otherwise, not the whole circle will fit in the canvas
    ) {
